...
Each virtual host needs to have a directory for storing virtual host data. Create directories and a directory structure at the following location /var/www. In our example, we’ve created testing.com and testing1.com directories, one for each domain name.

 > sudo mkdir -p /var/www/testing.com/html/

 > sudo mkdir -p /var/www/testing1.com/html/
 
 create a sample index.html page for each domain, using nano or your favorite text editor. Start with the first domain:
  
 > <p align="ceter">nano /var/www/testing.com/html/index.html</p>
 
 3. Add the following sample HTML:

```
   /var/www/testing1.com/html/index.html
 ...
 <body>
      <h1>Well done! Testing.com is working properly</h1>
 </body>
 <html>
 ```
 ...
 > nano /var/www/testing1.com/html/index.html
 
 ```
 <html>
 <head>
       <title>Welcome to Testing1!</title>
 </head>
 <body>
       <h1>Well done! Testing1.com is working properly</h1>
 </body>
 </html>
```
 ...
 > sudo chown –R www-data:www-data /var/www/testing1.com
...
Add the following configuration block to create a basic configuration file. This example uses the first test domain, testing.com. Make sure to enter the correct domain for your website:
...
DocumentRoot /var/www/testing.com/html

ErrorLog ${APACHE_LOG_DIR}/testing.com-error.log
CustomLog ${APACHE_LOG_DIR}/testing.com-access.log combined
...
> sudo nano /etc/apache2/sites-available/testing1.com.conf
...
ServerAlias www.testing1.com
DocumentRoot /var/www/testin1.com/html

ErrorLog ${APACHE_LOG_DIR}/testing1.com-error.log
CustomLog ${APACHE_LOG_DIR}/testing1.com-access.log combined
...
enable the testing.com
> sudo a2ensite testing.com.conf
 image 
 
enable the testing1.com
> sudo a2ensite testing1.com.conf
 image
