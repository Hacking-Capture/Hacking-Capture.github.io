...
Perfect, so I can edit this file and when root executes planner.sh it will then excute print.sh as the root user. I use Pentest Monkey Reverse Shell Cheatsheet for an already made reverse shell command, editing only local system IP address
