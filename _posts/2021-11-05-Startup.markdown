...
Perfect, so edit this file and when root executes planner.sh it will then excute print.sh as the root user. Use  Reverse Shell Cheatsheet for an made reverse shell command, editing only local system IP address
