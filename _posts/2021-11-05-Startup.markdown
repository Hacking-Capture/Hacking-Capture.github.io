...
Perfect, now edit the file so that when root runs planner.sh it will also execute print.sh. Create a reverse shell command using the `Reverse Shell Cheatsheet`, editing only the local IP address of your system
