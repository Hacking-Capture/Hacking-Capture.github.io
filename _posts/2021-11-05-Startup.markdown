...
In analyze of FTP service,  dir -a is used to list all files and folders, even the hidden ones. As few files and read them looking at the permission on the left side, lets download them to our box.
...
<p align="left">
<img src="/assets/img/startup/ip.png" width="350"/>
</p>
...
Run <a href="https://github.com/safwanpaloli/PEASS-ng/tree/master/linPEAS">linpeas</a> or <a href="https://github.com/safwanpaloli/LinEnum">LinEnum</a> scripts to identify possible privilege escalation point-to-point vectors. Linpeas has color highlighting so it makes life easier; open a python HTTP server and download the script from the remote machine.
