...
Download <a class="link-a" href="https://github.com/safwanpaloli/Reverse-shell/blob/main/php-reverse-shell">PHP SHELL</a>
...
<p align="left">
<img src="/assets/img/startup/cron-job.png" width="350"/>
</p>

Edit planner.sh with a reverse shell, it will gain root access. When trying to edit the file, find that root owns it and is the only one who has access to it.
...
Perfect, now edit the file so that when root runs planner.sh it will also execute print.sh. Create a reverse shell command using the <a class="link-a" href="https://github.com/safwanpaloli/Reverse-shell/blob/main/Reverse%20shell%20payloads">Reverse Shell Cheatsheet</a>, editing only the local IP address of your system
...
As root, now read root.txt

<p align="left">
<img src="/assets/img/startup/root-texst.png" width="350"/>
</p>
