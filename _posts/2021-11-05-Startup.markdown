...
If edit planner.sh with a reverse shell, it will gain root access. However, when trying to do, find that root owns the file and is the only user allowed to edit.
